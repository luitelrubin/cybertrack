...
# Country Choices
COUNTRY_CHOICES = [("Select Country", "Select Country"), ("Nepal", "Nepal")]
...
class Complaint(models.Model):
    complaint_id = models.CharField(
        default=generate_unique_id, unique=True, primary_key=True, editable=False
    )
    ...
    unique_id_card = models.FileField(
        upload_to="pdfs/documents/", blank=True, null=True
    )
