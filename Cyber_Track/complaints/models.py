...
# Choices for cities, organized by district
CITY_CHOICES = {
    'Select District': [
    ...
    'Morang': [
        ...
        ('Belbari', 'Belbari'),
        ('Pathari Sanischare', 'Pathari Sanischare'),
        ('Rangeli', 'Rangeli'),
    ],
    'Makwanpur': [
        ('Hetauda', 'Hetauda'),
...
class Complaint(models.Model):
    ...
    unique_id_card = models.FileField(upload_to='documents/' , blank=False, null=False)
    signature = models.FileField(upload_to='documents/', blank=False, null=False)
    screenshots = models.FileField(upload_to='documents/', blank=False, null=False)
