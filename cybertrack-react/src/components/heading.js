  ...
  return (
    <header className='flex shadow-[0px_4px_16px_rgba(17,_17,_26,_0.1),_0px_8px_32px_rgba(17,_17,_26,_0.05)] py-4 px-4 sm:px-6 bg-white font-[sans-serif] min-h-[75px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center gap-5 w-full max-w-screen-xl mx-auto'>
        <Link to="/home"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className='w-36' /></Link>
        ...
        <div id="collapseMenu" className='max-lg:hidden lg:!flex lg:ml-auto max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50'>
          ...
          <ul className='lg:flex gap-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            <li className='mb-6 hidden max-lg:block'>
              <Link to="/"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className='w-40' /></Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <Link to='/home' className='hover:text-[#007bff] text-[#007bff] font-semibold block text-[15px]'>Home</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <Link to='/complaint' className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Complaint</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <Link to='/notice' className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Notice</Link>
            </li>
            {auth.isAuthenticated ?(<></>):(
                          <li className='max-lg:border-b max-lg:py-3 px-3'>
                          <Link to='/login' className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Login</Link>
                        </li>
            )}
          </ul>
        </div>
