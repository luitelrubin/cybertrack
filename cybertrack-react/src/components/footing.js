      ...
      <div className="py-10 px-6 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm">Cyber Track is an online cybercrime complaint portal designed to streamline the reporting process for cyber incidents. Users can securely lodge their complaints, ensuring their concerns reach authorized personnel for swift action.</p>
          </div>

          <div>
            <h4 className="text-lg font-semibold mb-8 text-white">Navigation</h4>
            <ul className="space-y-4">
              <li><a href="/home" className="text-gray-300 hover:text-white text-sm">Home</a></li>
              <li><a href="/complaint" className="text-gray-300 hover:text-white text-sm">About</a></li>
